...
func Scrape(term string) {
	...
	var baseURL string = "https://www.jumpit.co.kr/api/positions?sort=relation&keyword=" + term
	...
	pages := getPages(baseURL, resultsPerPage)
	// fmt.Println(pages)
...
func getPage(page int, c chan<- []Position, url string) {
...
func getPages(url string, resultsPerPage int) int {
	pages := 0
